...
const CommandInput = styled.input`
    ${tw`text-sm transition-colors duration-150 px-2 bg-transparent border-0 border-b-2 border-transparent text-neutral-100 p-2 pl-0 w-full`}
`;
    ...
    return (
        <div css={tw`text-xs font-mono relative`}>
            ...
            <div css={tw`rounded-b bg-neutral-900 text-neutral-100 flex items-baseline`}>
                <div css={tw`flex-shrink-0 p-2 font-bold`}><FontAwesomeIcon icon={faTerminal} fixedWidth css={tw`mr-1`}/></div>
                <div css={tw`w-full`}>
                    <CommandInput
                        type={'text'}
