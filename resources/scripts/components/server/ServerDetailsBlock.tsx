...
import { faCircle, faEthernet, faHdd, faMemory, faMicrochip, faServer, faCompass } from '@fortawesome/free-solid-svg-icons';
...
const ServerDetailsBlock = () => {
    ...
    return (
        <TitledGreyBox css={tw`break-words`} title={name} icon={faServer}>
            ...
            <p css={tw`text-xs mt-2`}>
                <FontAwesomeIcon icon={faCompass} fixedWidth css={tw`mr-1`} /><code css={tw`ml-1`}>{node}</code>
            </p>
            <p css={tw`text-xs mt-2`}>
